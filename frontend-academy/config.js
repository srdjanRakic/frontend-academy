...
module.exports = {
  pathPrefix: '/frontend-academy',
  siteUrl: 'https://frontend-academy.github.io',
  siteTitle: 'Frontend Academy',
  siteDescription: 'Coding Bootcamp',
  author: 'srdjanRakic',
  ...
  tags: {
    ...
    redux: {
      description: 'Redux is an open-source JavaScript library for managing application state. It is most commonly used with libraries such as React or Angular for building user interfaces.'
    },
    nodejs: {
      name: 'Node.js',
